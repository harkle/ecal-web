...
module.exports = {
  ...
  programming: {
    ...
    "CSS": ['programming/css/introduction', 'programming/css/units', 'programming/css/colors', 'programming/css/text-font', 'programming/css/flow', 'programming/css/box-model'],
