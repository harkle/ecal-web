...
<BrowserWindow minHeight="250px" url="http://localhost:3000" src="/examples/test.html"></BrowserWindow>

## Code with content

<BrowserWindow minHeight="250px" url="http://localhost:3000">
  <h3>salut</h3>
</BrowserWindow>

## CodePen

<CodePen height="250px" src="https://codepen.io/bespoyasov/embed/YGAGLL?height=265&theme-id=dark&default-tab=html,result"></CodePen>
